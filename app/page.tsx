  ...
  return (
    <>
      <main>
        ...
        {/* Blog */}
        <section className="relative space-y-12 px-8 py-16 2xl:container md:px-16">
        ...
        {/* Info */}
        <ViewportReveal asChild>
          <section className="relative flex flex-col gap-6 px-8 py-16 2xl:container md:flex-row md:flex-wrap md:items-center md:px-16">
            <Card
              text="About"
